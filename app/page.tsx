        ...
        <div className="mx-auto max-w-7xl px-6 pb-30 py-12 grid gap-10 items-center">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <article key={i} className="rounded-lg border hover:border-(--color-6) overflow-hidden hover:shadow-[0_0_20px_color-mix(in_srgb,var(--color-1)_10%,transparent)]">
                <Image
                ...
                <div className="p-4 space-y-2">
                  <div className="text-xs text-(--color-2)">18.09.25</div>
                  <h3 className="font-semibold text-(--color-1)">Cost Reduction Assessment</h3>
                  ...
                  <Link href="/" className="text-sm text-(--color-4) underline underline-offset-4 font-semibold">
                    Read more
                  </Link>
                </div>
              </article>
